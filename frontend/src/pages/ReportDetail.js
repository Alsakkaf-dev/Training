...
import { ArrowLeft, Trash, UserMinus, Prohibit, Warning } from "@phosphor-icons/react";
...
export default function ReportDetail() {
  ...
  const base = location.pathname.startsWith("/admin") ? "/admin/reports" : "/moderation";
  ...
  return (
    <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
      ...
      <div className="bg-surface border border-line rounded-3xl p-4 shadow-card" data-testid="report-claim">
        ...
        <p className="text-xs text-muted mt-3">Reported by {report.reporter?.full_name}</p>
      </div>
        ...
        {report.is_user_report ? (
          ...
          <div className="flex items-center gap-3">
            ...
            <div className="flex-1">
              <p className="font-head font-semibold text-ink">{item.title}</p>
      ...
      {owner && (
        <div className="bg-surface border border-line rounded-3xl p-4 mt-3 shadow-card" data-testid="report-owner">
          <p className="label-eyebrow mb-2">Listing owner</p>
          <div className="flex items-center justify-between gap-3">
            <div className="flex items-center gap-3 min-w-0">
              <Avatar name={owner.full_name} src={owner.profile_picture} size={40} />
              <div className="min-w-0">
                <p className="font-semibold text-ink truncate">{owner.full_name}</p>
